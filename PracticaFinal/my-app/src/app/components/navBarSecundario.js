...
export default function NavBarSecundario() {
  return (
    <div className="w-full flex items-center justify-between p-4">
      <h1 className="text-3xl font-semibold text-gray-800">Cliente</h1>
      <div className="flex items-center gap-4 w-1/2 max-w-lg">
        <input className="w-full p-2 border-2 border-gray-300 rounded-lg shadow-sm" type="text" placeholder="Buscar cliente..."/>
